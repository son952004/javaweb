												...
												<tbody>
													<c:forEach var="saleOrder" items="${saleOrders }"
														...
														<tr>
															...
															<td>${saleOrder.ctName }</td>
															<td align="center">${saleOrder.ctMobile }</td>
															<td>${saleOrder.ctAdress }</td>
															<td align="right"><fmt:formatNumber
																	value="${saleOrder.total }" minFractionDigits="0"></fmt:formatNumber>
															</td>
															<td>${saleOrder.userSaleOder.username }</td>
															...
															<td><a
																href="${root }/edit-product/${saleOrder.id }"
																role="button" class="btn btn-primary">Edit</a>
															<td><a
																href="${root }/delete-product/${saleOrder.id }"
