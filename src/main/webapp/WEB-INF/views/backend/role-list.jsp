                                ...
                                <div class="table-responsive">
                               	...
                               	<div class="row">
										...
										<div class="form-group mb-4">
	                                        <a href="${resource }/admin/role/add" role="button" class="btn btn-primary">Add New Role</a>
                                      	</div>
                                   	</div>
                                        ...
                                        <tbody>
                                        	<c:forEach var="role" items="${roles }" varStatus="loop">
                                        		<tr>
	                                        		...
	                                        		<td>
	                                        			<a href="${resource }/admin/role/edit/${role.id }" role="button" 
	                                                							class="btn btn-primary">Edit</a>
	                                                	<a href="${resource }/admin/role/delete/${role.id }" role="button" 
