										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="pagination float-right">
													<div id="paging">
														<c:if test="${searchModel.currentPage > 1}">
                <li class="page-item">
                    <a class="page-link" href="?currentPage=${searchModel.currentPage - 1}&status=${param.status}&categoryId=${param.categoryId}&keyword=${param.keyword}" tabindex="-1">Previous</a>
                </li>
            </c:if>

            <!-- Nút các trang -->
            <c:forEach var="i" begin="1" end="${searchModel.totalPages}" varStatus="status">
                <li class="page-item <c:if test="${i == searchModel.currentPage}">active</c:if>">
                    <a class="page-link" href="?currentPage=${i}&status=${param.status}&categoryId=${param.categoryId}&keyword=${param.keyword}">${i}</a>
                </li>
            </c:forEach>

            <!-- Nút Next -->
            <c:if test="${searchModel.currentPage < searchModel.totalPages}">
                <li class="page-item">
                    <a class="page-link" href="?currentPage=${searchModel.currentPage + 1}&status=${param.status}&categoryId=${param.categoryId}&keyword=${param.keyword}">Next</a>
                </li>
            </c:if>
        </ul>
													</div>
