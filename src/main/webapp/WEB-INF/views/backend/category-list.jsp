                                ...
                                <div class="table-responsive">
                               	...
                               	<div class="row">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                        <!-- nó để lặp để lấy mỗi phần tử của list trong item truy suất đến và gắn vào biến cho đến khi hết --->
                                        	<c:forEach var="category" items="${categories }" varStatus="loop">
                                        		<tr>
		                                        	<td>${loop.index + 1 }</td>
		                                        	<td>${category.id }</td>
		                                        	<td>${category.name }</td>
		                                        	<td>${category.userCreateCategory }</td>
		                                        	<td>${category.userUpdateCategory }</td>
		                                        	<td>
